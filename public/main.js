var pictionary = function() { //deklarojme variablin pictionarin i cili eshte si funksion dhe brenda ketij funkioni do te 
    var canvas, context;     //do te deklarojme variablat qe do te na nevojiten 
    ...
    var send;
    var socket=io();
    var draw = function(position) { //kam variablen ose nje funksion te pictionarit i cili te na bej te mundur pozicionimin e mousit 
        ...
        context.fill();
        send=position;//ketu theras funksionin
...
//kam variablen ose nje funksion te pictionarit i cili te na bej te mundur pozicionimin e mousit 
        context.beginPath();//ketu eshte nje funksion i pictionarin qe ben te mundur nisjen e conteksit dmth vizatimi
        context.arc(a.x, a.y,// perseri nje funksion i pictionarit ne te cilin deklaroj 2 pozicione x dhe y dhe duke deklaruar variablt
                         6, 0, 2 * Math.PI);//Math pi eshte nje librari qe gjeneron numra 3.14
